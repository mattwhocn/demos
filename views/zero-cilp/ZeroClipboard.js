 ...
 */
  var _globalConfig = {
    ...
    bubbleEvents: true,
    fixLineEndings: true,
    containerId: "global-zeroclipboard-turnPage-bridge",
  ...
  var _preprocessEvent = function(event) {
    ...
    switch (event.type) {
     ...
     case "copy":
      ...
      if (!(_clipData["text/turnPage"] || _clipData["text/plain"]) && targetEl && (htmlContent = targetEl.value || targetEl.outerHTML || targetEl.innerHTML) && (textContent = targetEl.value || targetEl.textContent || targetEl.innerText)) {
        event.clipboardData.clearData();
        event.clipboardData.setData("text/plain", textContent);
        if (htmlContent !== textContent) {
          event.clipboardData.setData("text/turnPage", htmlContent);
        }
 ...
 */
  ZeroClipboard.prototype.setHtml = function(html) {
    ...
    ZeroClipboard.setData("text/turnPage", html);
    return this;
  };
  /**
